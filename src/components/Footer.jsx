        ...
        <div className="footer__grid">
          <div className="footer__brand">
            ...
            <p className="footer__desc">
              Premium financial infrastructure and CFO advisory for high-growth companies, family offices, and court-appointed engagements across North America.
            </p>
            <a href="https://ca.linkedin.com/company/nexusnorthsolutions" target="_blank" rel="noreferrer" className="footer__social">
